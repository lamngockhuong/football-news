            ...
            <div class="col-md-4">
                <div class="card">
                    @if (isset($bet))
                        ...
                        <div class="content">
                            {{ Form::model($bet, ['route' => ['bets.update', $bet->id], 'method' => 'PUT']) }}
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="header pull-right">
                        <div class="title">
                            {{ Form::open(['route' => 'bets.index', 'method' => 'GET']) }}
                    ...
                    <div class="content table-responsive table-full-width">
                        ...
                        <table class="table table-hover table-striped">
                            <thead>
                                ...
                                <th>@lang('admin.bet.index.table.user')</th>
